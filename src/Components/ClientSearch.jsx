...
{/* Above I am using the Bootstrap Classes */}
         ...
         <Select onChange={handleSelectClient} suffixIcon={<UserOutlined style={{color: secondary_color, fontSize: "20px"}}  />} showSearch={true} allowClear={true} filterOption={filterOption} options={currentOptions} placeholder={"Client"} style={{width: "310px", margin: "10px"}} />
