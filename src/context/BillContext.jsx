        ...
        billData: [
          {
            ...
            price: <PriceComponent _id={0} defaultInputValue={0} />,
            quantity: <QuantityComponent _id={0} />,
            amount: 0,
            order: 1,
            image_src: '',
          },
        ...
        switch (action.type) {
          ...
          case "ADD_ROW":
            const newItem = {
              ...
              price: <PriceComponent _id={state.billData.length} defaultInputValue={0} />,
              quantity: <QuantityComponent _id={state.billData.length} />,
              amount: 0,
              ...
              billData: filteredData.map((item, index) => 
                ...
                index === action.payload._key
                  ? {
                      ...
                      price: <PriceComponent _id={Number(index)} defaultInputValue={item.actualPrice} />,
                      quantity: <QuantityComponent _id={Number(index)} />,
