            ...
            case "REMOVE_ROW":
              ...
              return {
                  ...
                  billData: filteredData.map((item, index) => ({
                      ...item,
                      upload: <ImageSelector _id={Number(index)} reRender={true} renderSource={filteredData[index].image_src} />,
                      price: <PriceComponent _id={Number(index)} defaultInputValue={filteredData[index].actualPrice} reRender={true} />,
                      quantity: <QuantityComponent _id={Number(index)} defaultInputValue={filteredData[index].actualQuantity} reRender={true} />,
