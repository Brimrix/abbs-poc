  ...
  return (
    <>
      ...
      >
        ...
        <div style={{
          color: 'black', display: 'flex', gap: '10px', marginTop: '10px',
        }}
        >
          <Space>
          ...
          <Suspense fallback={<h1>Loading.....</h1>}>
            <Avatar
              size="small"
              style={{
                borderRadius: '50%', width: '32px', height: '32px', cursor: 'pointer', marginTop: '15px',
              }}
              icon={<UserOutlined />}
            />
          </Suspense>
      ...
      <Divider style={{
        backgroundColor: '#DCDCDC', marginTop: '0px', marginBottom: '0px', opacity: '45%',
      }}
      />
